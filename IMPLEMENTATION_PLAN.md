...
Use GitHub issue relationships for exact prerequisites.
...
Priority and Effort are desired values, not a claim that GitHub currently has them applied.
...
2. Use plan IDs in commits and coordination. Confirm direct prerequisites in GitHub before starting work.
